...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    public static OkHttpClient getOkHttpClient(){
        Api retrofitManager = sRetrofitManager.get(HostType.NEWS_SERVER);
        if (retrofitManager == null) {
            retrofitManager = new Api(HostType.NEWS_SERVER);
            sRetrofitManager.put(HostType.NEWS_SERVER, retrofitManager);
        }
